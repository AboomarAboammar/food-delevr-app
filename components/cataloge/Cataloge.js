...
import classes from "./Cataloge.module.css";

const Cataloge = ({ meals =[]}) => {
      ...
      <div className={classes.wrapper}>
        ...
        <div className={classes.categories}>
          ...
          <span
            ...
            className={`${classes.category} ${
              activeCategory === "pizza" ? classes.active : ""
            }`}
          >
            Pizza
          </span>
          <span
            ...
            className={`${classes.category} ${
              activeCategory === "burger" ? classes.active : ""
            }`}
          >
            Burger
          </span>
          <span
            ...
            className={`${classes.category} ${
              activeCategory === "gyros" ? classes.active : ""
            }`}
          >
            Gyros
          </span>
          <span
            ...
            className={`${classes.category} ${
              activeCategory === "spaghetti" ? classes.active : ""
            }`}
          >
            Spaghetti
          </span>
          <span
            ...
            className={`${classes.category} ${
              activeCategory === "bread" ? classes.active : ""
            }`}
          >
            Bread
          </span>
          <span
            ...
            className={`${classes.category} ${
              activeCategory === "vegetarian" ? classes.active : ""
            }`}
          >
            Vegetarian
          </span>
            ...
            {filteredMeals?.map((meal) => (
              ...
              >
                <div className={classes.imgContainer}>
                  <Image src={meal?.image} width="250" height="250" alt="" className={classes.imgFood} />
                </div>
